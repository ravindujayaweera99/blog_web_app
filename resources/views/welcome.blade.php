...
<body class="bg-main">
    ...
    <div class="hero-section w-full h-[50vh] lg:h-[50vh] bg-blue-200">
        <div class="bg-black/80 w-full h-full bg-opacity-[0.8] flex flex-col justify-center items-center px-32">
            <div>
            ...
            <div class="flex flex-col justify-center items-center gap-12">
                ...
                <a href={{route('register')}}
                    class="text-white text-2xl py-4 px-2 bg-purple rounded hover:text-black">Become a Member →</a>
            </div>
        </div>
    </div>
