...
<body>
    <header class="flex flex-col md:flex-row justify-between items-center py-6 px-32 shadow-md bg-black text-white">
        <h1 class="text-xl md:text-2xl">✍🏻 My Blog App</h1>
        @if (Route::has('login'))
            <div class="-mx-3 flex flex-1 justify-end">
                ...
                <a href={{route('aboutus')}}
                    class="list-none rounded-md px-3 py-2 text-white text-sm my-auto md:text-xl ring-1 ring-transparent transition hover:text-blue-500  focus:outline-none focus-visible:ring-[#FF2D20]">
                    <li>About Us</li>
                </a>
    ...
    <div class="hero-section w-full  h-[90vh] bg-blue-200 gap-6">
        <div class="bg-black w-full h-full bg-opacity-[0.6] flex flex-col justify-center items-center">
            <h1 class="text-5xl text-white font-bold">Share your Thoughts with the World!</h1>
            <h2 class="text-2xl text-white">Turn your Thoughts into Blogs</h2>
        </div>
    </div>

    <h1 class="text-center text-3xl my-12">Latest Blogs</h1>
