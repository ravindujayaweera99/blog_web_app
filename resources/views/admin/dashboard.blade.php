    ...
    <x-slot name="header">
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="bg-gray-50 overflow-hidden shadow-xl sm:rounded-lg p-8 lg:p-16 flex flex-col justify-center items-center border border-gray-200">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="bg-gray-50 overflow-hidden shadow-xl sm:rounded-lg p-8 lg:p-16 flex flex-col lg:flex-row justify-center items-center lg:gap-8 border border-gray-200">
